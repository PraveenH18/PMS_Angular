...
public getClinicalInformationBySource(): void {
  ...
  public capturePatientScreen()  
  {  
    var data = document.getElementById('demographicDetails')!;    
    html2canvas(data).then(canvas => {  
      ...
      pdf.save('MyDetails.pdf'); // Generated PDF   
    });  
  }  
  public captureAllergyScreen()  
  {  
    var data = document.getElementById('allergyDetails')!;
    ...
    html2canvas(data).then(canvas => {  
      ...
      var position = 0;  
      pdf.addImage(contentDataURL, 'PNG', 0, position, imgWidth, imgHeight)  
      pdf.save('MyAllergyDetails.pdf'); // Generated PDF   
    });  
  }  
}
